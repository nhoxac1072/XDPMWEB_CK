                                ...
                                <table cellspacing="0" class="shop_table cart">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="product-size">Brand</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            <td class="product-remove">
                                                <a title="Remove this item" class="remove" href="{{URL::to('/delcart', [$item->id,$item->options] )}}">X</a> 
                                            </td>
                                            ...
                                            <td class="product-name">
                                                <a href="{{URL::to('/productdetail',$item->id )}}">{{$item->name}}</a> 
                                            </td>
                                            ...
                                            <td class="product-quantity">
                                                <div class="quantity buttons_added">
													<a class="add_to_cart_button" href="{{URL::to('/incqtycart', [$item->id,$item->options] )}}">+</a>
                                                    
                                                    <input type="number" size="4" class="input-text qty text" value="{{$item->qty}}" min="0" readonly>
													
													<a class="add_to_cart_button" href="{{URL::to('/decqtycart', [$item->id,$item->options] )}}">-</a>
                                            ...
                                            <td>
                                                 {{($item->options->has('thuonghieusp') ? $item->options->thuonghieusp : '')}}
                                            </td>
                                        ...
                                        <tr>
                                            <td class="actions" colspan="8" style="text-align:right"> 
                                                <label>Total:</label>
