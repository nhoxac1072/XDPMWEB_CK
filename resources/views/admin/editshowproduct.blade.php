                            ...
                            {{csrf_field()}}
                                <form role="form" action="{{URL::to('update-showproduct/'.$value->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" class="form-control" id="FileUpload1" 
                                            accept="image/*"/>
                                    ...
                                    <div class="form-group">
                                        <label>  loại sản phẩm </label> 
                                            ...
                                            @if($pro->cateid ==$value->cateid)
                                            {
                                                <option selected value="{{$pro->cateid}}">{{$pro->name}}</option>}
                                            @else
                                                <option value="{{$pro->cateid}}">{{$pro->name}}</option>
                                            @endif
                                            @endforeach
                                            </Select>
                                    </div>
                                    <div class="form-group">
                                        <label>  thương hiệu </label>
                                            ...
                                            @if($brand->brandid ==$value->brandid)
                                                <option selected value="{{$brand->brandid}}">{{$brand->name_dongSP}}</option>
                                            @else
                                                <option value="{{$brand->brandid}}">{{$brand->name_dongSP}}</option>
                                            @endif
                                            @endforeach
                                            </Select>
                                    </div>
