...
class showproductcontroller extends Controller
{
    ...
    {
        $cate =DB::table('product')->orderBy('cateid','desc')->get();
        $brand = DB::table('dongsp')->orderBy('brandid','desc')->get();
    ...
    {
       $allproduct = DB::table('showproduct')->join('product', 'product.cateid','=','showproduct.cateid')
       ->join('dongsp', 'dongsp.brandid','=','showproduct.brandid')
    ...
    {
        $cate_product = DB::table('product')->orderBy('cateid','desc')->get();
        $brand_product = DB::table('dongsp')->orderBy('brandid','desc')->get();
